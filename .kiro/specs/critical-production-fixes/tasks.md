...
- [x] 21. Создание production build
...
- [x] 22. Создание кроссплатформенных исполняемых файлов
  - Создать Windows .exe файл с помощью Electron или Tauri
  - Создать Linux .AppImage с помощью AppImageKit
  - Создать Android .apk с помощью React Native
  - Настроить автоматическую сборку для всех платформ
  - Протестировать исполняемые файлы на целевых платформах
